...
for (i in 1:10){
  ...
  id_down_data<-unlist(lapply(EMR_down$Patient_index, function(x) grep(x,EMR_long_diags_multivariate$Patient_index)))
  EMR_long_diags_multivariate_down<-EMR_long_diags_multivariate[id_down_data,]
