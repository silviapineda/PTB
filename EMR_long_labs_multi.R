...
for( i in 1:10){
  ...
  for(j in 1:length(lambda)){
    ...
    glm1 <- try(glmmLasso(Term ~ X.Int.l.Normaliz.Ratio._order+X..Saturation_order+Activated.Partial.Thromboplastin.Time_order+AFI..cm._order+Alanine.transaminase_order+Albumin..Random_order+Albumin..Serum...Plasma_order+Alkaline.Phosphatase_order+Amylase..Serum...Plasma_order+Anion.Gap_order+Aspartate.transaminase_order+Atrial.Rate_order+Basophil.Abs.Count_order+Bile.Acids..Total_order+Bilirubin..Total_order+Biophysical.Profile.Score..of.10._order+Biophysical.Profile.Score..of.8._order+C.Reactive.Protein_order+Calcium..Ionized..serum.plasma_order+Calcium..total..Serum...Plasma_order+Calculated.P.Axis_order+Calculated.R.Axis_order+Calculated.T.Axis_order+Carbon.Dioxide..Total_order+CD3.T.Cells.._order+CD3.T.Cells.Abs_order+CD4.CD8.Ratio_order+CD4.T.Cells.._order+CD4.T.Cells.Abs_order+CD8.T.Cells.._order+CD8.T.Cells.Abs_order+Chloride..Serum...Plasma_order+Complement.C3..serum_order+Complement.C4..serum_order+Creat.per.Day..UR_order+Creatinine_order+Creatinine..random.urine_order+DEEPEST.VERTICAL.POCKET..CM._order+Double.Stranded.DNA.Antibody_order+eGFR.if.African.Amer_order+eGFR.if.non.African.American_order+Eosinophil.Abs.Ct_order+Factor.VIII.Act..Average_order+FEF.25.75....PRED_order+FEF.25._order+FEF.25....PRED_order+FEF.50._order+FEF.50....PRED_order+Ferritin_order+Fetal.Breathing_order+Fetal.Movement_order+Fetal.Tone_order+FEV1_order+FEV1...FVC_order+FEV1...FVC..PRED_order+FEV1..PRED_order+FHR.Baseline_order+Fibrinogen..Functional_order+Fluid.Volume_order+Folate..RBC_order+Free.T3..Adult_order+Free.T4_order+FVC_order+FVC..PRED_order+Gamma.Glutamyl.Transpeptidase_order+Glu.Tol.Post.Glucola_order+Glucose.Loading.Screen_order+Glucose...UA._order+Glucose..120.Mins_order+Glucose..180.Mins_order+Glucose..60.Mins_order+Glucose..fasting_order+Glucose..Fasting..Pregnant..2.hr.GTT_order+Glucose..Fasting..Pregnant..3.hr.GTT_order+Glucose..meter.download_order+Glucose..non.fasting_order+HBV.Log.IU.mL_order+HBV.Real.Time_order+Hematocrit_order+Hemoglobin_order+Hemoglobin.A_order+Hemoglobin.A1c_order+Hemoglobin.A2_order+Heparin.Level_order+Hours.Collected_order+ICD9.Code_order+Imm.Gran..Left.Shift_order+Iron..serum_order+Ketones..UA_order+Lactate.Dehydrogenase..Serum...Plasma_order+Lactate..plasma_order+Lipase_order+LV.Mass.Index..BSA..by.M.Mode_order+LVEDVi_order+LVEF.by.MOD.Bi.plane_order+LVESVi_order+Lymphocyte.Abs.Cnt_order+Magnesium..Serum...Plasma_order+
                            MCH_order+MCHC_order+MCV_order+Methylmalonic.Acid..serum_order+Mins.Post.Gluc.Dose_order+Mitogen.Control_order+Monocyte.Abs.Count_order+Neutrophil.Absolute.Count_order+NIL.Control_order+Nonstress.Test_order+OGT.Glucola.Dose_order+P.R.Interval_order+Parvo.Ab.B19.IgG_order+PEAK.FLOW_order+PEAK.FLOW..PRED_order+pH..UA_order+Phosphorus..Serum...Plasma_order+Platelet.Count_order+PO2_order+POCT.Glucose_order+POCT.pH..UA_order+POCT.Spec.Grav..UA_order+Potassium..Serum...Plasma_order+Prot.Concentration.UR_order+Prot.Total.per.Day.UR_order+Protein.Creat.Ratio..random_order+Protein..Total..Serum...Plasma_order+Protein..UA_order+PT_order+QRS.Duration_order+QT.Interval_order+QTcb_order+RBC.Count_order+RBCs...Units.Ready_order+RDW_order+Retic.Count..Flow.Cytometry_order+Ristocetin.Cofactor_order+Rubella.Antibody_order+RVVT.Seconds_order+Sedimentation.Rate_order+Sodium..Serum...Plasma_order+Specific.Gravity_order+T4..Total_order+Tacrolimus_order+Thyroid.Stimulating.Hormone_order+Thyroid.Stimulating.Immunoglobulin_order+Total.Volume.Collected_order+Transferrin_order+Triglycerides..serum_order+Urea.Nitrogen..Serum...Plasma_order+Uric.Acid..Serum...Plasma_order+Ventricular.Rate_order+Vitamin.B12_order+Vitamin.D..25.Hydroxy_order+von.Willebrand.Factor.Antigen_order+WBC.Count_order+Weight.In.Kg_order+X.Int.l.Normaliz.Ratio.+X..Saturation+Activated.Partial.Thromboplastin.Time+AFI..cm.+Alanine.transaminase+Albumin..Random+Albumin..Serum...Plasma+Alkaline.Phosphatase+Amylase..Serum...Plasma+Anion.Gap+Aspartate.transaminase+Atrial.Rate+Basophil.Abs.Count+Bile.Acids..Total+Bilirubin..Total+Biophysical.Profile.Score..of.10.+Biophysical.Profile.Score..of.8.+C.Reactive.Protein+Calcium..Ionized..serum.plasma+Calcium..total..Serum...Plasma+Calculated.P.Axis+Calculated.R.Axis+Calculated.T.Axis+Carbon.Dioxide..Total+CD3.T.Cells..+CD3.T.Cells.Abs+CD4.CD8.Ratio+CD4.T.Cells..+CD4.T.Cells.Abs+CD8.T.Cells..+CD8.T.Cells.Abs+Chloride..Serum...Plasma+Complement.C3..serum+Complement.C4..serum+Creat.per.Day..UR+Creatinine+Creatinine..random.urine+DEEPEST.VERTICAL.POCKET..CM.+Double.Stranded.DNA.Antibody+eGFR.if.African.Amer+eGFR.if.non.African.American+Eosinophil.Abs.Ct+Factor.VIII.Act..Average+
                            FEF.25.75....PRED+FEF.25.+FEF.25....PRED+FEF.50.+FEF.50....PRED+Ferritin+Fetal.Breathing+Fetal.Movement+Fetal.Tone+FEV1+FEV1...FVC+FEV1...FVC..PRED+FEV1..PRED+FHR.Baseline+Fibrinogen..Functional+Fluid.Volume+Folate..RBC+Free.T3..Adult+Free.T4+FVC+FVC..PRED+Gamma.Glutamyl.Transpeptidase+Glu.Tol.Post.Glucola+Glucose.Loading.Screen+Glucose...UA.+Glucose..120.Mins+Glucose..180.Mins+Glucose..60.Mins+Glucose..fasting+Glucose..Fasting..Pregnant..2.hr.GTT+Glucose..Fasting..Pregnant..3.hr.GTT+Glucose..meter.download+Glucose..non.fasting+HBV.Log.IU.mL+HBV.Real.Time+Hematocrit+Hemoglobin+Hemoglobin.A+Hemoglobin.A1c+Hemoglobin.A2+Heparin.Level+Hours.Collected+ICD9.Code+Imm.Gran..Left.Shift+Iron..serum+Ketones..UA+Lactate.Dehydrogenase..Serum...Plasma+Lactate..plasma+Lipase+LV.Mass.Index..BSA..by.M.Mode+LVEDVi+LVEF.by.MOD.Bi.plane+LVESVi+Lymphocyte.Abs.Cnt+Magnesium..Serum...Plasma+MCH+MCHC+MCV+Methylmalonic.Acid..serum+Mins.Post.Gluc.Dose+Mitogen.Control+Monocyte.Abs.Count+Neutrophil.Absolute.Count+NIL.Control+Nonstress.Test+OGT.Glucola.Dose+P.R.Interval+Parvo.Ab.B19.IgG+PEAK.FLOW+PEAK.FLOW..PRED+pH..UA+Phosphorus..Serum...Plasma+Platelet.Count+PO2+POCT.Glucose+POCT.pH..UA+POCT.Spec.Grav..UA+Potassium..Serum...Plasma+Prot.Concentration.UR+Prot.Total.per.Day.UR+Protein.Creat.Ratio..random+Protein..Total..Serum...Plasma+Protein..UA+PT+QRS.Duration+QT.Interval+QTcb+RBC.Count+RBCs...Units.Ready+RDW+Retic.Count..Flow.Cytometry+Ristocetin.Cofactor+Rubella.Antibody+RVVT.Seconds+Sedimentation.Rate+Sodium..Serum...Plasma+Specific.Gravity+T4..Total+Tacrolimus+Thyroid.Stimulating.Hormone+Thyroid.Stimulating.Immunoglobulin+Total.Volume.Collected+Transferrin+Triglycerides..serum+Urea.Nitrogen..Serum...Plasma+Uric.Acid..Serum...Plasma+Ventricular.Rate+Vitamin.B12+Vitamin.D..25.Hydroxy+von.Willebrand.Factor.Antigen+WBC.Count+Weight.In.Kg+Patient_Ethnicity+Patient_Marital_Status+Patient_Smoking_Status+Patient_Age+Patient_Race
