...
# paste(colnames(EMR_long_labs_multivariate)[31:60],collapse ="+")
# paste(colnames(EMR_long_labs_multivariate)[61:100],collapse ="+")
# paste(colnames(EMR_long_labs_multivariate)[101:ncol(EMR_long_labs_multivariate)],collapse ="+")
# 
...
set.seed(54)
EMR_long_labs_patient<-EMR_long_labs_multivariate[match(unique(EMR_long_labs_multivariate$Patient_index),EMR_long_labs_multivariate$Patient_index)
...
for( i in 1:10){
  ...
  EMR_long_labs_test<-EMR_long_labs_multivariate[id_test_data,] ##2685
  EMR_long_labs_train<-EMR_long_labs_multivariate[-(id_test_data),] ##10529
